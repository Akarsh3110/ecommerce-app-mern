...
export const getAllOrdersForAdmin=createAsyncThunk('/order/getAllOrdersForAdmin',
    async()=>{
        const response=await axios.get(`${process.env.REACT_APP_API_URL}/api/admin/orders/get`
        );
...
export const getOrderDetailsForAdmin=createAsyncThunk('/order/getOrderDetailsForAdmin',
    async(id)=>{
        const response=await axios.get(`${process.env.REACT_APP_API_URL}/api/admin/orders/details/${id}`
        );
        return response.data
    }
)
export const updateOrderStatus=createAsyncThunk('/order/updateOrderStatus',
    async({id,orderStatus})=>{
        const response=await axios.put(`${process.env.REACT_APP_API_URL}/api/admin/orders/update/${id}`,
            {orderStatus}
        );
        return response.data
    }
